...
namespace MVCAppConsumingBAREAPI.Models.ViewModels
{
    ...
    public class ApartmentUnitCreateVM
    {
        public ApartmentUnitCreateDTO ApartmentUnit { get; set; }
        
        [ValidateNever]
        public IEnumerable<SelectListItem> ApartmentComplexList { get; set; }
        
        public ApartmentUnitCreateVM() { 
        
              ApartmentUnit = new ApartmentUnitCreateDTO();
        }
    }
}
