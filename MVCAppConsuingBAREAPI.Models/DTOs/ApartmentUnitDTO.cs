...
namespace MVCAppConsumingBAREAPI.Models.DTOs
{
    public class ApartmentUnitDTO
    {
        ...
        // since this DTO is used in GET (read) operations, we include the apartment complex DTO
        // (since we don't have an Apartment Class here)
        ...
        public ApartmentComplexDTO ApartmentComplex { get; set; }
    }
}
